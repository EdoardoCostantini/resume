...
{Department of Methodology and Statistics}   % Extra Info
{
    ...
    \begin{spacing}{1.1}
    \begin{itemize}
        \item \textbf{Research software development} | I developed a standalone package to estimate a special type of principal component analysis. I also contributed to the development of a variety of R packages in the field of social science (e.g., mice, statcheck). 
