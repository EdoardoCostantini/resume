...
{Department of Methodology and Statistics}   % Extra Info
{
    ...
    \begin{spacing}{1.1}
    \begin{itemize}
        \item \textbf{Academic research} | I developed cutting-edge algorithms to address non-response bias in questionnaires.
        ...
        \item \textbf{Coordination} | I managed small groups of teaching assistants for multiple iterations of the main statistics course in a data science master program.
    \end{itemize}
    \end{spacing}
    \vspace{1em}
}
